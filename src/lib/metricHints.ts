export const PERFORMANCE_SCORE_HINT =
  'Per-game composite score: role-specific stats (KDA, GD@15, CS@15, DPM, KP, vision, etc.) are min–max normalized against the same-role split cohort, weighted by role, then averaged across games in the past 7 days. Player of the Week is the highest weekly average. Scale: 0–100 (100 = at or above cohort best on each weighted stat).'
