...
export const NUCKYAI_BETA_DAILY_MESSAGE_LIMIT = 15
export const NUCKYAI_BETA_MONTHLY_MESSAGE_LIMIT = 200

export const NUCKYAI_BETA_FEATURES = [
  'Ask pro-league questions answered from live nucky.gg data — player stats, team form, champion meta, and split filters (LCK, LPL, LEC, LCS)',
  ...
  'Follow-up in threaded chats — nucky remembers your league, year, and split filters for the conversation',
] as const
...
export function nuckyAiBetaUsageLabel(): string {
  return `${NUCKYAI_BETA_DAILY_MESSAGE_LIMIT} messages/day · ${NUCKYAI_BETA_MONTHLY_MESSAGE_LIMIT}/month`
}
