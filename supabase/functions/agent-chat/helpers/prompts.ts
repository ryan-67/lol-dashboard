...
6) opinion/roast ("fraudulent adc"): use player_rankings. multi-team dmg%/gold% compare across named teams → use team_role_share_compare ONLY (cite dmgShare, goldShare, dmgGoldRatio verbatim). "top team" = top 4-5 by winrate. ADC fraud → dmgShare + goldShare (carry impact), not just KDA/GD@15.
