...
| 25 | T1 winrates line graph all of 2026 | FAIL | PASS* | B1 | `winrates` intent + Winter/Spring regional chart |
| 26 | What did Reddit say about last GEN vs T1 series? | FAIL | PASS* | B3/B5 | series_player_analysis + reddit fail-closed |
| 27 | What's on the LCK schedule this week? | FAIL | PASS* | B4 | `recentSeriesFromOE` — no invented reverse sweeps |
